...
class GUI:
    def __init__(self, project_parameters):
        ...
        self.loss_label = Label(self.window, text='', fg='black')
    ...
    def run(self):
        ...
        self.loss_label.pack(anchor=tk.N)
